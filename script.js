const sections = [
  {
    ...
    title: "Статті",
    description:
      "Наукові статті, опубліковані або підготовлені до подання",
    items: [
      {
        title:
  ...
  },
  {
    ...
    title: "Тези",
    description:
      "Матеріали конференцій, тези доповідей та збірники",
    items: [
      {
        title:
    ...
    items: [
      {
        title: "Силабус",
        description:
          "Силабус курсу - Проєктування систем RAG для освітніх потреб",
        status: "Документ",
        href: "Силабус.docx",
      },
      {
      ...
      {
        title: "Оцінка використання ШІ в науковій роботі",
        description: "Сервіс для декларування студентами використання ШІ в науковій діяльності, який генерує ПДФ декларацію для подальшого використання її при захисті. Сервіс був розроблений як приклад реалізації політики використання ШІ на рівні університету",
        status: "Сервіс",
        href: "https://gen-ai-politics.vercel.app/",
      },
    ],
  },
  {
